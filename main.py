...
def recolectar_alertas() -> list[dict]:
    ...
    # (viento, ráfagas, lluvia, nieve, helada). Para reactivar SENAPRED,
    ...
    # No hereda umbral de ninguna comuna: usa el default global + override
    # propio del punto, comparado contra su propio dato de consenso.
    for nombre, lat, lon, comuna_ref, region in PUNTOS_ESPECIFICOS:
        try:
            ...
            todas_las_alertas += evaluar_umbrales(nombre, datos, umbrales)
        except Exception:
